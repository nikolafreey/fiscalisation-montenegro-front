...
import { FORGOT_PASSWORD, GET_USER, LOGIN, LOGOUT, RESET_PASSWORD } from '../actionTypes/UserActionTypes';
import {
  fizickoLiceStore,
  fizickaLicaGet,
  fizickoLiceGet,
...
import { userForgotPassword, userGet, userLogin, userLogout, userResetPassword } from './UserSagas';
