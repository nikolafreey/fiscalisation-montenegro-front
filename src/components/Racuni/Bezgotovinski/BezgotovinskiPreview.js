...
const BezgotovinskiPreview = () => {
    ...
    const {
        ...
        ukupan_iznos_pdv,
        status_placanja,
        iznos_uplate, datum_izdavanja } = useSelector(racunSelector());
    ...
    return (
        <>
            ...
            <div className="title">
                ...
                {!editMode && <div className="df w-50 jc-end">
            ...
            <div className="main-content__box">
                ...
                <div style={{ display: 'none' }}>
                    <BezgotovinskiShowTemplate ref={componentRef}
                        ikof={ikof}
                        jikr={jikr}
                        ...
                        <div className="invoice__footer">
                            <div className="row">
                                ...
                                <div className="col-md-4">
                                    <div className="df jc-sb">
                                        <div className="df fd-column">
                                            <p className="fw-500">{ukupna_cijena_bez_pdv && 'Bez PDV-a:'}</p>
                                            <p className="fw-500">{ukupan_iznos_pdv && 'Ukupno PDV:'}</p>
                                            <p className="fw-500">{ukupna_cijena_sa_pdv && 'Ukupno:'}</p>
                                        </div>
                                        <div className="df fd-column">
                                            <p className="fw-500 txt-right">
                                                {ukupna_cijena_bez_pdv ? ukupna_cijena_bez_pdv : ''} {ukupna_cijena_bez_pdv ? <span className="txt-up txt-light">Eur</span> : null};
                                            </p>
                                            <p className="fw-500 txt-right">
                                                {ukupan_iznos_pdv ? ukupan_iznos_pdv : ''} {ukupan_iznos_pdv ? <span className="txt-up txt-light">Eur</span> : ''}
                                            </p>
                                            <p className="fw-500 txt-right">
                                                {ukupna_cijena_sa_pdv ? ukupna_cijena_sa_pdv : ''} {ukupna_cijena_sa_pdv ? <span className="txt-up txt-light">Eur</span> : ''}
                                            </p>
                                        </div>
                                    </div>
                                </div>
            ...
            {editMode &&
                <Formik
                    initialValues={{
                        ...
                        partner,
                        created_at,
                        stavke, ukupna_cijena_bez_pdv, ukupna_cijena_sa_pdv, ukupan_iznos_pdv, status_placanja, iznos_uplate, datum_izdavanja
                    }}
