...
const NoviRacunShowTemplate = () => {
    ...
    return (
        <>
            ...
            <div className="main-content__box" style={{
                    ...
                    <div className="fiscal-bill">
                        <div className="fiscal-bill__header">
                            ...
                            <div className="fiscal-bill__header--info">
                                <p>   {racun.preduzece && racun.preduzece.puni_naziv
                                    ? racun.preduzece.puni_naziv
                                    : ''}</p>
                                <p> {racun.preduzece && racun.preduzece.adresa ? racun.preduzece.adresa : ''}</p>
                                <p> {racun.preduzece && racun.preduzece.grad ? racun.preduzece.grad : ''}, &nbsp;
                                    {racun.preduzece && racun.preduzece.drzava ? racun.preduzece.drzava : ''}</p>
                                <p>PIB: {racun.preduzece && racun.preduzece.pib ? racun.preduzece.pib : ''}</p>
                            </div>
                            <span>Operater: {racun && racun.kod_operatera ? racun.kod_operatera : '-'}</span>
                        </div>

                        <div className="fiscal-bill__body">
                            <table cellspacing="0" cellpadding="0">
                                {racun && racun.stavke.length > 0 ? racun.stavke.map((stavka) => {
                                    return <tr>
                            ...
                            <td className="right">{racun && racun.ukupna_cijena_sa_pdv}</td>
                                </tr>
                                <tr>
                            ...
                            <table cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td className="right"><h2>{racun && racun.ukupna_cijena_sa_pdv}</h2></td>
                                </tr>
                            </table>
                        </div>
