...
class NoviRacunPrintTemplate extends React.Component {
  ...
  render() {
    const {preduzece, kod_operatera, stavke, ukupna_cijena_sa_pdv, ukupan_iznos_pdv, jikr, ikof, broj_racuna} = this.props.racun;
    return (
      <>
          ...
          <div className="fiscal-bill">
            ...
            <div className="fiscal-bill__body">
              <table cellspacing="0" cellpadding="0">
                { stavke.length > 0 ? stavke.map((stavka) => {
                  return <tr>
              ...
              <table cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td className="right"><h2>{ ukupna_cijena_sa_pdv}</h2></td>
                </tr>
              </table>
            </div>
