...
import { getAtributiGrupe, setOdabraniAtributGrupa } from '../../../store/actions/RacuniActions';
import { atributiGrupeSelector, odabraniAtributGrupaSelector } from '../../../store/selectors/RacuniSelector';
...
const NoviRacunFilteri = () => {
  ...
  function isSelected(atributGrupa) {
    ...
    if (atributGrupa.tip_atributa_id)
      return atributGrupa.tip_atributa_id === odabraniAtributGrupa.tip_atributa_id;
