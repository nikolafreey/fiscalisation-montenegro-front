  ...
  return (
    <div class="user-nav">
      ...
      <div class="user-nav__profile" id="profile">
        ...
        <div class="user-nav__drop-down" id="ddl">
          <a href="#">
            <svg class="icon icon__dark md" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div class="user-nav">
      ...
      {user ? (
        <div class="user-nav__profile" id="profile">
          ...
          ></div>
          <div class="user-nav__drop-down" id="ddl">
            <img className="icon icon__dark md" src={userIcon} alt="profile" />
            Profile
            <img className="icon icon__dark md" src={loginIcon} alt="logout" />
